...
import { MessageSquare, Mail, Lock, ArrowRight, Eye, EyeOff, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 flex items-center justify-center p-4 selection:bg-indigo-500 selection:text-white relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 text-sm mt-1.5">Sign in to continue to your conversations</p>
        </div>
        ...
        <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-700/30 p-7 rounded-2xl shadow-2xl shadow-black/20">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link 
                  to="/forgot-password" 
                  className="text-xs text-indigo-400 hover:text-indigo-300 font-medium transition-colors hover:underline underline-offset-2"
                >
                  Forgot password?
                </Link>
              </div>
          ...
          <div className="mt-6 pt-5 border-t border-slate-700/30 text-center">
            <p className="text-sm text-slate-400">
              ...
              <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-semibold transition-colors hover:underline underline-offset-2">
                Create one
              </Link>
            </p>
          </div>
